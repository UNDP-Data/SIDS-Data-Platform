...
mviIndicatorsDict = {
  expConc: "Exportconcentration",
  expInst: "ExportInstability",
  agrInst: "AgriculturalInstability",
  agrGDP: "AgricultureandfishingasshareofGDP",
  victims: "Victimsofdisasters",
  popLECZ: "Shareofpopulationinlowelevatedcoastalzones",
  remote: "Remoteness", //"popDry": "%PopulationinDrylands",
  tourism: "Tourismrevenuesasshareofexports",
  fdi: "FDIinflowsaspercentageofGDP",
  remit: "RemittancesaspercentageofGDP",
};
...
//   if (
//     selectedViz == "Spider" ||
//     selectedViz == "Multi-indicator" ||
//     selectedViz == "Choropleth" ||
//     selectedPage == "countryDataTab"
//   ) {
//     try {
...
//     } catch (error) {
//       indicator2 = "HumanDevelopmentIndex";
//     }
...
//     d3.select(sidsMaps)
//       .selectAll(".choroRectMvi")
//       .transition()
//       .duration(1200)
//       .attr("x", function () {
//         return rectTransformData[countryJson[this.parentNode.id].Country]["x"];
//       })
//       .attr("y", function () {
//         return rectTransformData[countryJson[this.parentNode.id].Country]["y"];
//       })
//       .attr("width", 0)
