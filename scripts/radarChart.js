function RadarChart(parent_selector, options, layerList, pillar, dataFull) {
	...
	if (pillar != "customIndex") {
		...
		axis.append("text")
			...
			.on('mouseover', function (d, i) {
				...
				try {
					pillarData = allKeyData[layerList[0]][pillar]
			...
			.on('mouseover', function (d, i) {
				...
				parent.selectAll(".radarArea")
					...
					.filter(function (layer) {
						//	console.log(d)
							return layerList.indexOf(layer.name)>layerList.indexOf(d.name)-1
						})
						.transition().duration(200)
